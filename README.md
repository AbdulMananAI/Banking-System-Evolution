🚀 Project Overview
This is a comprehensive cmd based banking application that manages user accounts, transactions, and data persistence. It serves as a foundation for understanding how real-world financial software handles data security and logic flow.

🛠️ Current Features (C++ Legacy Version)
...
[x] Phase 1: Functional C++ implementation with File Handling (Current).
